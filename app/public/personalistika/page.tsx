...
export default function PublicPersonalistikaPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    const res = await fetch("/api/public/personalistika", {
      method: "POST",
      body,
    });
    ...
    setSuccess(data.message ?? "Formulář byl odeslán.");
    setLoading(false);
    router.push("/public/personalistika/odeslano");
  };
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div key={key}>
                  ...
                  <select value={form[key as LanguageKey]} onChange={(e) => setLanguageLevel(key as LanguageKey, e.target.value)} className="w-full rounded-lg border border-gray-300 px-3 py-2">
