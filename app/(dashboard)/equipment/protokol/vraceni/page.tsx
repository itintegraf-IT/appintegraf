...
export default async function PrintVraceniPage({
  searchParams,
}: {
  ...
  const returnedDay = data.returned_at
    ? new Date(data.returned_at).toLocaleDateString("cs-CZ")
    ...
    <>
      ...
      <div className="equipment-protocol-print mx-auto px-2 py-4">
        ...
        <div className="ep-header">
          <h1>PROTOKOL O VRÁCENÍ</h1>
          <p style={{ margin: "5px 0", fontSize: "11px" }}>Vrácení majetku na sklad</p>
        </div>
        ...
        <div className="ep-section">
          <div className="ep-section-title">VRÁCENÍ</div>
          <div style={{ fontSize: "10px" }}>
            <p style={{ margin: "5px 0" }}>
              Vybavení bylo vráceno dne: <strong>{returnedDay}</strong>
            </p>
            {data.notes && (
              <>
                <p style={{ margin: "5px 0" }}>
                  <strong>Poznámka k předání:</strong>
                </p>
        ...
        <div className="ep-signatures">
          <div className="ep-sig-box">
            <p>
              <strong>Převzal zpět do skladu:</strong>
            </p>
            <br />
            <br />
