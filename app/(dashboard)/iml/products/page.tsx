...
import { ImlProductsClient } from "./ImlProductsClient";

export default async function ImlProductsPage() {
    ...
    <>
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">Katalog produktů</p>
        </div>
      ...
      <ImlProductsClient canWrite={canWrite} canRead={canRead} />
    </>
  );
}
