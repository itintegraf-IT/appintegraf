...
def Ulozeni_PDF(CestaTxtL, Cesta, JOB,BALIL,NT,OK_Print):
     ...
     if JOB.count("CD_POP_NEXGO")==1 or JOB.count("CD_POP")==1 or JOB.count("CD_Vnitro")==1  or JOB.count("CD_Validator") ==1 or JOB.count("DPB_AVJ")   :
         ...
         #ST = FPDF(orientation='L', unit='mm', format=(105, 148))#  štítek na jednu stránku
         #ST = FPDF(orientation='L', unit='mm', format=(125, 148))#  štítek na jednu stránku
         ST = FPDF(orientation='P', unit='mm', format=("A4"))#  štítek na jednu stránku
         ST.add_page()  # štítek na jednu stránku
         ST.add_font('DejaVu-Bold', '', 'Fonty\\DejaVuSansCondensed-Bold.ttf', uni=True) # font Latin1
         ST.add_font('DejaVu', '', 'Fonty\\DejaVuSansCondensed.ttf', uni=True) # font Latin1 # po run vznikne .pkl, které  obsahuje nastavení vč. cesta
         for  CestaTxt in CestaTxtL:
                ...
                BL.add_page();
                BL.set_font('DejaVu', '', 6);  BL.cell(0, 10, CISLO , border=0, ln = 2, align="L")                
                ...
                if JOB.count("_NEXGO")==1:
                        Job_nazev=("Jízdní doklad POP NEXGO");
                        Typ_dokladu=("Hm 0 735 2 4125    KSM  2252384");               
                elif JOB.count("CD_POP")==1:
                        Job_nazev=("Jízdní doklad POP");
                        Typ_dokladu=("Hm 0 735 2 4116    KSM  2103671");
                elif JOB.count("CD_Vnitro")==1:
                        Job_nazev=("Jízdní doklad vnitrostátní");
                        Typ_dokladu=("Hm 0 735 2 4123    KSM 2187909");
                elif JOB.count("CD_Validator")==1:
                        Job_nazev=("Jízdenka do validátoru");
                        Typ_dokladu=("Hm 0 735 2 4124    KSM 2252349");                               
                elif JOB.count("DPB_AVJ")==1:
                        BL.image('Loga\\logoDPB.png', 15, 15, 25)# logo
                        Job_nazev=("              Kotuče na tlač cestovných lístkov");
                        Typ_dokladu=("           Sml. č.:     ");
                ...
                Krab_cislo="Krabice č: " +C_KRAB_NA_PALETE+"   " ;  Mnozstvi="Počet ks: "+MNOZSTVI
...
# ŠTÍTEK
                ...
                ST.set_xy(dx, dy)
                if JOB.count("NEXGO")==1:
                        Job_nazev=("Jízdní doklad POP NEXGO");
                        Typ_dokladu=("Hm 0 735 2 4125    KSM  2252384");               
                elif JOB.count("CD_POP")==1 and JOB.count("NEXGO")==0:
                        Job_nazev=("Jízdní doklad POP");
                        Typ_dokladu=("Hm 0 735 2 4116    KSM  2103671");
                elif JOB.count("CD_Vnitro")==1:
                        Job_nazev=("Jízdní doklad vnitrostátní");
                        ...
                        ST.image(CWD+'\\Loga\\logoDPB.png', dx, dy-2, 15)
                        ST.image(CWD+'\\Loga\\logIG2.png', dx+65, dy+30, 25)# logo
                        Job_nazev=   ("               Kotuče na tlač cestovných lístkov");
                        Typ_dokladu=("                  Sml. č.:     ");
                ...
                VypisS=""                 
                if JOB.count("DPB_AVJ")==1 or JOB.count("CD_Vnitro")==1 or JOB.count("CD_Validator")==1: # doplnění do štítků
                    for radek in VypisL:
                        radekL=radek.split ("|")
                        #print (radekL)
                        VypisS=VypisS+radekL[0]+"/"+radekL[1]+"/"+radekL[2]+"   "
                    ST.set_font('DejaVu', '', 8.1); th=1.2*ST.font_size;
                    #VypisS=VypisS.join(VypisL[0]).replace("\n","||")
                    #VypisS=VypisS+VypisL.split ("|")[0]
                    #VypisS=VypisS.replace("\n","  ")
                    ST.set_fill_color(220, 220, 220)
                    ST.multi_cell (86, 3, VypisS, 1,0,1); ST.set_x(dx) #vnucená pozice po Multicell  
                ...
                ST.cell(0, 1.4, "", 0,  ln = 2 )# prázdný řádek
                Krab_cislo="Serie: "+  Serie +  "   Krabice č.: "  +C_KRAB_NA_PALETE+"." +"       Počet ks v bal: "+MNOZSTVI
                #ST.set_xy(dx, dy+26)
                ...
                # číslo krab:
                ST.cell(0, 1.4, "", 0,  ln = 2 )# prázdný řádek
                ST.set_font('DejaVu', '', 7);  ST.cell(0, th, CISLO, border=0, ln = 2, align="L")
     ...
     ST.output(cestaPDF_S)   #uložení Štítku                        
...
#Ulozeni_PDF( ['C:\\Users\\malam\\Desktop\\AAAA\\REZANI\\CD_Vnitro\\\\TXT\\1_YB.txt', 'C:\\Users\\malam\\Desktop\\AAAA\\REZANI\\CD_Vnitro\\\\TXT\\2_YC.txt','C:\\Users\\malam\\Desktop\\AAAA\\REZANI\\CD_Vnitro\\\\TXT\\3_YD.txt','C:\\Users\\malam\\Desktop\\AAAA\\REZANI\\CD_Vnitro\\\\TXT\\4_YE.txt', 'C:\\Users\\malam\\Desktop\\AAAA\\REZANI\\CD_Vnitro\\\\TXT\\5_YF.txt'] , "C:\\Users\\malam\Desktop\AAAA\\REZANI\\CD_Vnitro\\", "CD_Vnitro" ," ", (0, 0) , "OK" )
