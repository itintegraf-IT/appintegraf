...
| Dokument | Popis |
|----------|-------|
| [MODUL_KALENDAR.md](MODUL_KALENDAR.md) | Kalendář – týdenní/měsíční zobrazení, CRUD, filtry, drag & drop, schvalování, **barva podle typu**, **opakování**, **připomínky (notif + e-mail, cron)**, export .ics |
