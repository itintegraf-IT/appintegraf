/**
 * Migrace modulu IT Školení: podpora více správných odpovědí u otázek.
 * Použití: node scripts/run-training-multi-answer-migration.mjs
 */
...
const SQL_PATH = join(
  ...
  "prisma",
  "migrations",
  "20260728100000_training_multi_answer",
  "migration.sql"
);
...
async function main() {
  ...
  await conn.end();
  console.log("\nMigrace multi-answer dokončena.");
}
