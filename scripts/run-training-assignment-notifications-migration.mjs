/**
 * Migrace: notifikace u přiřazení testů.
 * Použití: npm run db:training-assignment-notifications
 */
...
const SQL_PATH = join(
  ...
  "prisma",
  "migrations",
  "20260728140000_training_assignment_notifications",
  "migration.sql"
);
...
async function main() {
  ...
  await conn.end();
  console.log("\nMigrace notifikací přiřazení dokončena.");
}
