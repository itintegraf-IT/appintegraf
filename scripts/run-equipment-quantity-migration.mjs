/**
 * Přidá sloupec quantity do equipment_items.
 * Použití: npm run db:equipment-quantity
 */
...
const sqlPath = join(
  ...
  "prisma",
  "migrations",
  "20260824140000_equipment_item_quantity",
  "migration.sql"
);
...
async function main() {
  ...
  await conn.end();
  console.log("\nMigrace equipment_items.quantity dokončena.");
}
