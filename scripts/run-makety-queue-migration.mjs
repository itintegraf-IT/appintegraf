/**
 * Přidá sloupec queue_position do tabulky makety.
 * Použití: npm run db:makety-queue
 */
...
const sqlPath = join(root, "prisma", "migrations", "20260603_makety_queue_position.sql");
...
async function main() {
  ...
  await conn.end();
  console.log("\nMigrace queue_position dokončena.");
}
