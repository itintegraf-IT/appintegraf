/**
 * Přidá sloupec work_type do tabulky makety.
 * Použití: npm run db:makety-work-type
 */
...
const sqlPath = join(root, "prisma", "migrations", "20260602_makety_work_type.sql");
