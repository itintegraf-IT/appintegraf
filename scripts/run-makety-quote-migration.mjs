/**
 * Přidá sloupce pro schvalování ceny maket.
 * Použití: npm run db:makety-quote
 */
...
const sqlPath = join(root, "prisma", "migrations", "20260604_makety_quote_approval.sql");
...
async function main() {
  ...
  await conn.end();
  console.log("\nMigrace quote approval dokončena.");
}
