/**
 * Migrace: přiřazení testů konkrétním uživatelům.
 * Použití: npm run db:training-assignment-users
 */
...
const SQL_PATH = join(
  ...
  "prisma",
  "migrations",
  "20260728120000_training_assignment_users",
  "migration.sql"
);
...
async function main() {
  ...
  await conn.end();
  console.log("\nMigrace přiřazení uživatelů dokončena.");
}
