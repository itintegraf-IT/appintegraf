...
import { loadColumnSizing, saveColumnSizing } from "@/lib/crm/table-state";
...
export function DataTable<TData>({
  ...
  function pushParams(changes: Record<string, string | null>) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion -- typedRoutes vyžaduje branded Route type
