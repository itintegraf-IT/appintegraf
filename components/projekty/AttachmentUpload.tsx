...
export function AttachmentUpload({ parentType, parentId }: { parentType: ParentType; parentId: string }) {
  ...
  async function onChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      fd.append("file", file);
      const res = await fetch("/api/projekty/attachments", { method: "POST", body: fd });
      if (!res.ok) {
