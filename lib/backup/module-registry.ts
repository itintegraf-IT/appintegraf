...
export const BACKUP_MODULES: Record<BackupModuleId, BackupModuleDef> = {
  ...
  crm: {
    ...
    dependsOn: ["system"],
    tables: [
      prisma("crm_lost_reasons"),
      prisma("crm_deal_categories"),
      prisma("crm_companies"),
      prisma("crm_contacts"),
      prisma("crm_deals"),
      prisma("crm_deal_contacts"),
      prisma("crm_activities"),
      prisma("crm_notes"),
      prisma("crm_attachments"),
      prisma("crm_audit_log"),
      prisma("crm_notifications"),
      prisma("crm_ai_insights"),
      prisma("crm_ai_usage"),
      prisma("crm_graph_sync_state"),
      prisma("crm_graph_accounts"),
    ],
    extraUploadDirs: ["crm"],
  },
  kiosk: {
